 ...
 * 模型靠 description 和 parameters 来「看懂」它能调什么、参数长啥样。
 *
 * 与 agent-lab/src/lib/tools.ts 对齐，作为「把 Agent 能力接进 NestJS」的教学示例。
 */
...
/**
 * 工具执行器：模型只负责「决定调哪个工具 + 传什么参数」，真正干活的是这里的代码。
 * 返回字符串会作为 tool 消息回填给模型，模型据此生成最终回答。
 */
